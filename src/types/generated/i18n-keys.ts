...
export const translationKeys = [
  ...
  'rules.page.provider.actions.add',
  'rules.page.title',
  'rules.page.actions.editRules',
  'rules.page.actions.exportBundle',
  'rules.page.actions.importBundle',
  ...
  'rules.feedback.notifications.bundle.exportSuccess',
  'rules.feedback.notifications.bundle.exportFailed',
  'rules.feedback.notifications.bundle.importSuccess',
  'rules.feedback.notifications.bundle.importFailed',
  'rules.feedback.notifications.bundle.nothingToExport',
  'rules.feedback.notifications.bundle.rejected.notAZip',
  'rules.feedback.notifications.bundle.rejected.manifestMissing',
  'rules.feedback.notifications.bundle.rejected.manifestInvalid',
  'rules.feedback.notifications.bundle.rejected.formatVersion',
  'rules.feedback.notifications.bundle.rejected.unsafeEntryPath',
  'rules.feedback.notifications.bundle.rejected.contentMissing',
  'rules.feedback.notifications.bundle.rejected.contentCorrupt',
  'rules.feedback.notifications.bundle.rejected.contentInvalid',
  ...
  'rules.modals.provider.titleAdd',
  'rules.modals.provider.titleEdit',
  'rules.modals.provider.form.labels.name',
  'rules.modals.provider.form.labels.type',
  'rules.modals.provider.form.labels.behavior',
  'rules.modals.provider.form.labels.url',
  'rules.modals.provider.form.labels.path',
  'rules.modals.provider.form.labels.interval',
  'rules.modals.provider.form.options.type.http',
  'rules.modals.provider.form.options.type.file',
  'rules.modals.provider.form.options.behavior.domain',
  'rules.modals.provider.form.options.behavior.ipcidr',
  'rules.modals.provider.form.options.behavior.classical',
  'rules.modals.provider.form.validation.nameRequired',
  'rules.modals.provider.form.validation.urlRequired',
  'rules.modals.provider.form.validation.pathRequired',
  'rules.modals.provider.form.validation.nameDuplicate',
  'rules.modals.deleteProvider.title',
  'rules.modals.deleteProvider.messageNoReference',
  'rules.modals.deleteProvider.messageWithReference',
  'rules.modals.deleteProvider.warningDropsRuleOverride',
  'rules.modals.deleteProvider.actions.clearAndDelete',
  'rules.modals.exportBundle.title',
  'rules.modals.exportBundle.fileFilter',
  'rules.modals.exportBundle.summary',
  'rules.modals.exportBundle.subscriptionAddressWarning',
  'rules.modals.exportBundle.actions.export',
  'rules.modals.importBundle.title',
  'rules.modals.importBundle.summary',
  'rules.modals.importBundle.newerMinor',
  'rules.modals.importBundle.policyMappingTitle',
  'rules.modals.importBundle.policyMappingHint',
  'rules.modals.importBundle.policyRequired',
  'rules.modals.importBundle.conflictTitle',
  'rules.modals.importBundle.conflict.skip',
  'rules.modals.importBundle.conflict.overwrite',
  'rules.modals.importBundle.conflict.rename',
  'rules.modals.importBundle.conflict.newName',
  'rules.modals.importBundle.conflict.nameTaken',
  'rules.modals.importBundle.conflict.skipReferenced',
  'rules.modals.importBundle.providerSourceNotice',
  'rules.modals.importBundle.actions.import',
